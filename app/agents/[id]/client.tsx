...
import type { Agent, SmallAgent } from '@/lib/types/agent.types';
...
export default function AgentDetailsClient({ agent }: AgentDetailsClientProps) {
  ...
  const smallAgent = isSmallAgent ? (agent as SmallAgent) : null;
          ...
          <Card>
            ...
            <CardContent className="space-y-4">
              <div className="grid grid-cols-2 gap-4">
                <div>
                  <p className="text-sm font-medium">Business Process</p>
                  <p className="text-sm text-muted-foreground">
                    {smallAgent.businessProcess}
                  </p>
                </div>
                <div>
                  <p className="text-sm font-medium">Schedule</p>
                  <p className="text-sm text-muted-foreground">
                    {smallAgent.configuration.schedule || 'Not scheduled'}
                  </p>
                </div>
              </div>
              <div>
                ...
                <div className="flex flex-wrap gap-2">
                  {smallAgent.configuration.integrations.map((integration: string) => (
              ...
              <div>
                <p className="text-sm font-medium mb-2">Process Parameters</p>

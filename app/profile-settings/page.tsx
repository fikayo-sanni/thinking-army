          ...
          <Card className="border-[#E5E7EB] dark:bg-[#1A1E2D] dark:border-[#2C2F3C]">
            <CardHeader>
              <CardTitle className="text-white uppercase tracking-wide flex items-center space-x-2">
                <User className="h-5 w-5 text-[#0846A6] dark:text-[#00E5FF]" />
            ...
            <CardContent className="space-y-6">
              ...
              <div className="flex flex-col items-center space-y-4">
                <div className="relative">
                  <Avatar className="h-24 w-24 ring-4 ring-[#00E5FF]/20">
                    ...
                    <AvatarFallback className="bg-gradient-to-br from-[#0846A6] dark:from-[#00E5FF] to-[#6F00FF] text-white text-2xl font-bold">
                  ...
                  <Button
                    size="sm"
                    className="absolute -bottom-2 -right-2 h-8 w-8 rounded-full bg-[#0846A6] text-[#FFFFFF] dark:bg-[#00E5FF] dark:hover:bg-[#00E5FF]/90 dark:text-black p-0"
                  >
              ...
              <div className="space-y-4">
                ...
                <div className="flex items-center justify-between p-3 border rounded-lg dark:bg-[#0D0F1A] border-[#E5E7EB] dark:border-[#2C2F3C]">
                  ...
                  <span className="dark:text-[#00E5FF] text-[#0846A6] font-bold">{profileData.totalEarnings}</span>
                </div>
                <div className="flex items-center justify-between p-3 border rounded-lg dark:bg-[#0D0F1A] border-[#E5E7EB] dark:border-[#2C2F3C]">
          ...
          <div className="lg:col-span-2 space-y-6">
              ...
              <CardContent className="space-y-6">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div className="space-y-2">
                    ...
                    <Input
                      ...
                      className="dark:bg-[#0D0F1A] dark:border-[#2C2F3C] text-white focus:border-[#00E5FF]"
                    />
                  </div>
                  <div className="space-y-2">
                ...
                <div className="space-y-2">
                  ...
                  <div className="relative">
                    ...
                    <Input
                      ...
                      className="pl-10 dark:bg-[#0D0F1A] dark:border-[#2C2F3C] text-white focus:border-[#00E5FF]"
                    />
                  </div>
                </div>
                ...
                <div className="space-y-2">
                  ...
                  <Textarea
                    ...
                    className="dark:bg-[#0D0F1A] dark:border-[#2C2F3C] text-white focus:border-[#00E5FF] min-h-[100px]"
                  />
                </div>
              </CardContent>
            </Card>
            ...
            <Card className="border-[#E5E7EB] dark:bg-[#1A1E2D] dark:border-[#2C2F3C]">
              ...
              <CardContent className="space-y-4">
                <div className="flex items-center justify-between p-4 rounded-lg dark:bg-[#0D0F1A] border border-[#E5E7EB] dark:border-[#2C2F3C]">
                  <div>
